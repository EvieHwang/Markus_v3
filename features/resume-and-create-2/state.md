...
|----|-------------|------|--------|-------|
| T-001 | `LastFileStore` (C1) — durable last-opened reference | 1 | pending | |
| T-002 | `NameProbe` (C5) — collision-free `Untitled` naming | 1 | pending | |
| T-003 | `LocalDocumentsFallback` (C7) — always-available create target | 1 | pending | |
