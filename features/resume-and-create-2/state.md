...
| T-005 | `BrowserHost` (C0) — `UIDocumentBrowserViewController`-backed scene host | 3 | complete | PENDING_SHA — UIKit App via AppDelegate (D-002); save via MarkdownDocumentSaveBridge (D-003) |
