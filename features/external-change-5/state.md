...
|----|-------------|------|--------|-------|
| T-001 | `ContentEqualityGate` (DC-11) — byte-or-newline-normalized equality | 1 | in-progress | |
| T-002 | `LastKnownDiskState` (DC-9, DC-10) — clean/dirty authority on the document model | 1 | in-progress | |
| T-003 | `ConflictResolution` (DC-13) — Keep Mine / Keep Theirs / Discard Mine end-states | 1 | in-progress | |
