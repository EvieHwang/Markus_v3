...
| T-004 | Dynamic Type typography in RenderedView | 2 | in-progress | |
| T-005 | Wire MarkdownLineBreakNormalizer into RenderedView | 2 | in-progress | |
| T-006 | HIG semantic colors + .bar material audit | 2 | in-progress | |
