...
|----|-------------|------|--------|-------|
| T-001 | `WriteOutcomeBus` + success-only side-effect gating (DC-1/2/3) | 1 | in-progress | |
| T-002 | `ReconciliationLiftRefresh` on `reconcileOnForeground()` lift branch (DC-16/17/18/19/20) | 1 | in-progress | |
| T-003 | Coordinated write + save-back gate + scoped-resource discipline on the live bridge (DC-4/5/6/7/8/9) | 2 | pending | |
