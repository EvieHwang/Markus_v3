...
|----|-------------|------|--------|-------|
| T-001 | `WriteOutcomeBus` + success-only side-effect gating (DC-1/2/3) | 1 | pending | |
| T-002 | `ReconciliationLiftRefresh` on `reconcileOnForeground()` lift branch (DC-16/17/18/19/20) | 1 | pending | |
