...
| T-003 | Coordinated write + save-back gate + scoped-resource discipline on the live bridge (DC-4/5/6/7/8/9) | 2 | complete | 3b35052 |
| T-004 | `SaveFailedAlertRouter` — single-alert lifecycle, background latch, conflict precedence, no double-fire (DC-10/11/12/13/14/15) | 3 | complete | (sha pending) |
