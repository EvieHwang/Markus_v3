...
|----|-------------|------|--------|-------|
| T-001 | Delete C5 `NameProbe` (source + unit tests) | 1 | in-progress | |
| T-002 | Delete C6 `CreateTargetResolver` (source + unit tests, incl. writability probe) | 1 | in-progress | |
| T-003 | Delete C7 `LocalDocumentsFallback` (source + unit tests) | 1 | in-progress | |
