// LastFileStoreBookmarkFallbackTests.swift
// Spec tests for resume-and-detector-hardening-11 — bookmark-fallback resolve.
//
...
//
// Covers:
//   C1 LastFileStore — bookmark-fallback branch (DC-1/DC-3/DC-4/DC-6)
//
// BRs covered: BR-1, BR-2, BR-3, BR-4, BR-5, BR-6, BR-7, BR-14, BR-15, BR-16.

import Testing
import Foundation
@testable import Markus_v3

@Suite("LastFileStore — bookmark-fallback resolve")
struct LastFileStoreBookmarkFallbackTests {
